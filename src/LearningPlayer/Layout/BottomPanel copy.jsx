...
const BottomPanel = ({ courseId }) => {
  ...
  const submitReview = async (e) => {
    ...
    const reviewData = {
      course_Id: "682b2cb8e914a0b8f8d562c5",
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      setAnnouncements([]); // Replace with fetched data
      setLoading(false);
    }, 1000);
  }, []);

  // Define tab keys separately from display text
  ...
  const handleDownloadCertificate = async () => {
    if (!certificate.background) {
      toast.warning("Certificate not ready.");
      return;
    }
    ...
    <>
      <div className="video_tabs_area">
        ...
        <div className="tab-content" id="pills-tabContent">
          {/* Overview Tab */}
          {/* <div className="tab-pane fade show active" id="pills-overview" role="tabpanel">
          <div className="video_about">
            ...
            <div>
              <button
                onClick={() => {
                  toast.warning(t("A certificate will be generated after 80% of the course is completed."), {
                    position: "top-right",
                    autoClose: 1500,
                    ...
                    progress: undefined,
                    theme: "colored",
                    style: { color: "#28282a" }, // This sets the text color to black
                  })
                }}
