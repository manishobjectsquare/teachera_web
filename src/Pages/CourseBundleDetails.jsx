...
const CourseBundleDetails = () => {
      ...
      try {
        ...
        if (result.status && result.data) {
          ...
          const transformedData = {
            bundleDetails: {
              _id: result.data._id,
              ispurchase: result.data.ispurchase,
            ...
            courses:
              result.data.courses?.map((course) => ({
                ...
                arabic_description:
                  course.arabic_description?.replace(/<[^>]*>/g, "") ||
                  course.arabic_seo_description,
  ...
  const isFree = bundle?.bundleDetails?.price === 0;
  const isPurchased = bundle?.bundleDetails?.isPurchase === true;
  const courseInCart = isInCart(bundle?.bundleDetails?._id);
  if (loading) {
    return (
      <div
                    ...
                    <div className="bundle-course-card" key={course._id}>
                      <div className="course-card-header">
                        ...
                        <div className="course-info">
                          <Link
                            to={
                              bundle?.bundleDetails?.ispurchase
                          ...
                          <div className="course-meta">
                            {bundle?.bundleDetails?.ispurchase ? (
                              <div className="thm-btn w-auto text-center  rounded add-to-cart">
                                <Link
                ...
                <div className="course-dtl-main-content">
                  ...
                  <div className="course-dtl-main-btn">
                    <button
                      ...
                      disabled={bundle?.bundleDetails?.ispurchase}
                    >
                      {cartLoading ? (
                        <span
