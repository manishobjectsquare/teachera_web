...
// import Course from "../assets/images/course-img-01.png";
...
//         "https://api.basementex.com/api/v1/web/course-filter"
//       );
...
//     let filterdata = categories.filter((arr) => arr?._id === e.target.value);
//     console.log(filterdata);
//     setSubCategory(filterdata[0].subcat);
//   };
...
//         return course.categorySlug === selectedMainCategory;
//       });
//       if (orderBy === "desc") {
//         filteredCourses.sort((a, b) => a.id - b.id);
//       } else {
//         filteredCourses.reverse((a, b) => b.id - a.id);
//       }
...
//   }, [selectedMainCategory, selectedLanguages, orderBy]);
...
//         <div className={`preloader-two ${loading ? "" : "d-none"}`}></div>
...
//                   <div
//                     id="filter-acc-02"
//                     className="sub-category-holder accordion-collapse collapse"
//                   >
//                     <div className="accordion-body">
//                       <ul className="">
...
//               <div>
//                 <Link onClick={clearFilters} className="">
//                   {t("Clear Filters")}
//                 </Link>
//               </div>
...
//                     {t("Latest to Oldest")}
//                   </option>
//                   <option value="desc">{t("Oldest to Latest")}</option>
//                 </select>
//               </div>
//             </div>
...
//                                   </span>{" "}
//                                   <del className="ms-1">${course?.price}</del>
//                                 </>
//                               ) : (
//                                 <span>
//                                   ${course?.discount_price.toFixed(2)}
