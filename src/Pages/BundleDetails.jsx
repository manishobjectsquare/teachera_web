    ...
    const fetchDiplomaData = async () => {
      ...
      try {
        ...
        const response = await fetch(
          `${baseUrl}/api/v1/web/bundle/bundle-view/${id}`,
          {
            method: "GET",
            headers: {
                            ...
                            <img
                              src={
                                course.thumbnail
                                  ...
                                  : `/placeholder.svg?height=120&width=200&text=${course.title.split(" ")[0]
                                  }`
                              }
                              alt={course.title}
                              onError={(e) => {
                                e.target.src = `/placeholder.svg?height=120&width=200&text=${course.title.split(" ")[0]
                                  }`;
                              }}
                            />
                            ...
                            <img
                              src={
                                liveCourse.image
                                  ...
                                  : `/placeholder.svg?height=120&width=200&text=${liveCourse.title.split(" ")[0]
                                  }`
                              }
                              alt={liveCourse.title}
                              onError={(e) => {
                                e.target.src = `/placeholder.svg?height=120&width=200&text=${liveCourse.title.split(" ")[0]
                                  }`;
                              }}
                            />
                            <div className="course-overlay">
                    ...
                    <div className="bg-blue-600  p-4 mt-4 course-infos rounded">
                      ...
                      <div className="row g-3">
                        ...
                        <div className="col-12">
                          <div
                            className={`d-flex align-items-center gap-3 ${isRTL ? "flex-row-reverse" : ""
                              }`}
                          >
                            <svg
                              width="20"
